  ...
  return (
    ...
    >
      <p className="pokeId">
        <img
          className="pokeball"
          src="https://www.dlf.pt/dfpng/middlepng/597-5970982_pokeball-pixel-png-transparent-png.png"
        />{" "}
        {"00" + props.pokemons.id}
      </p>
      <img src={props.pokemons.url} alt={props.pokemons.name} />
      <h2 className="pokename">{props.pokemons.name}</h2>

      <ul className="poketype">{fichasPokemon}</ul>
    </article>
  );
}
